#Adittional-Content
print("###---: CONNECTED-TO-THE: Contacts :---###")
USER = input("ENTER-YOUR-NAME-TO-GET-ACCESS: ")
print("Thank-You-For-Accessing-Our-DataBase:", USER)

# source: https://github.com/wellingtoncosta/fake-contacts-json/blob/master/db.json
contacts = [
      {
        "id": 1,
        "name": "Elma Herring",
